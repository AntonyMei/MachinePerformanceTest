...
step_ratio_wrt100k = 8
batch_ratio_wrt256 = 2
...
class AtariConfig(BaseConfig):
    def __init__(self):
        super(AtariConfig, self).__init__(
            ...
            last_steps=3000,
            test_interval=5000,
            log_interval=int(1000 / step_ratio_wrt100k),
            vis_interval=int(1000 / step_ratio_wrt100k),
            test_episodes=16,
            # self-play
            ...
            lr_warm_up=0.01 * step_ratio_wrt100k,
            lr_init=0.4,
            lr_decay_rate=0.1,
            lr_decay_steps=int(100000 / step_ratio_wrt100k),
            auto_td_steps_ratio=0.3,
            # replay window
            start_transitions=12,
